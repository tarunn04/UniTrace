              ...
              builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    bool isMe = sender == _detailController.driver.first.email; // Change this to check against the current user's ID
                              ...
                              Flexible(
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: isMe ? redBg: Colors.grey.shade200,
                    ...
                    child: IconButton(
                      onPressed: (){
                        ...
                        FirebaseFirestore.instance.collection('messages').add({
                          ...
                          'userName': _detailController.driver.first.name,
                          'senderEmail':_detailController.driver.first.email,
                          'role':_detailController.driver.first.role,
                        });
